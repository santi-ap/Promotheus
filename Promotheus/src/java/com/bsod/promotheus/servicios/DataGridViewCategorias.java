 ...
 */
@ManagedBean(name = "DataGridViewCategorias")
@SessionScoped
public class DataGridViewCategorias implements Serializable {
    ...
    public DataGridViewCategorias() {
    }

    @PostConstruct
    public void init() {
        promos = service.selectPromosCategorias(this.controller.getEleccion());
    }
